<div class="breadcrumbs">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Laporan Service</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        $("input[name=end]").on("change",function(){
            ...
            jQuery("#data").DataTable().ajax.url("<?=base_url("report/json/service");?>/"+start+"/"+end).load();
        });
        ...
        $("#data").DataTable({
            ...
            "autoWidth":true,
            "order": [],
            "ajax": {"url": "<?=base_url("report/json/service");?>"},
            "columnDefs": [
                {
                    'targets': 0,
        ...
        $(".btn-print").on("click",function(){
            ...
            if(start && end) {
                var url = "<?=base_url("report/report_pdf");?>/service/"+start+"/"+end;
            } else {
                var url = "<?=base_url("report/report_pdf");?>/service";
            }
